...
The strict TDD requirement and the Post-Implementation five-bucket QA gate that apply on top of this table live in `../core/engineering-rules.md` and `../agents/qa.md` — this file holds facts (commands, coverage gaps), not obligations.
